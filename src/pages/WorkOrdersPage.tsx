...
export default function WorkOrdersPage() {
  ...
  const { data, isLoading, isError, error, refetch } = useMyWorkOrders({ page, pageSize: PAGE_SIZE }, isBackendSession);
  ...
  return (
    <AppLayout title="Мои наряды" subtitle="Реальные данные backend">
      {!isBackendSession ? (
        <BackendSessionRequired roleHint="Brigadir" />
      ) : (
        <Card>
