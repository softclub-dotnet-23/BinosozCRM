...
export default function BrigadirDashboardPage(){
 const navigate=useNavigate(); const {showToast}=useToast(); const chartAnim=useChartAnimation(); const [period,setPeriod]=useState("Месяц"); const [search,setSearch]=useState("");
