...
export const APP_STRINGS: Record<Language, AppStrings> = {
  ...
  tj: {
    ...
    brigadirReports: {
      ...
      dynamicsTitle: "Динамикаи иҷрои корҳо", seriesPlanned: "Нақша", seriesActual: "Воқеӣ", seriesRate: "% иҷро",
  ...
  en: {
    ...
    brigadirReports: {
      ...
      dynamicsTitle: "Work completion dynamics", seriesPlanned: "Planned", seriesActual: "Actual", seriesRate: "% completion",
