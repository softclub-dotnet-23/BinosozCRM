...
export const mockUsers: UserAccount[] = [
  ...
  { id: "user-worker-1", login: "rustam.saidov", fullName: "Рустам Саидов", role: "worker", status: "active", phone: "+992 900 11 22 33", email: "rustam.saidov@binosoz.tj", registeredAt: "2026-01-15", employeeId: employeeIdFor("Рустам Саидов") },
