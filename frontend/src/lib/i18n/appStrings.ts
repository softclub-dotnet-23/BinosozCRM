...
export const APP_STRINGS: Record<Language, AppStrings> = {
  ru: {
    ...
    common: {
      ...
      roleLabels: { owner: "Владелец", accountant: "Бухгалтер", prorab: "Прораб", brigadir: "Бригадир" },
  ...
  tj: {
    ...
    common: {
      ...
      roleLabels: { owner: "Соҳиб", accountant: "Бухгалтер", prorab: "Прораб", brigadir: "Бригадир" },
  ...
  en: {
    ...
    common: {
      ...
      roleLabels: { owner: "Owner", accountant: "Accountant", prorab: "Foreman", brigadir: "Crew lead" },
